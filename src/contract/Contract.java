...
public class Contract {
    private int contractInsuranceID, price;
	...
	public int getContractID() {
        return contractInsuranceID;
    }
    public void setContractID(int contractID) {
        this.contractInsuranceID = contractID;
    }
    ...
    public void setInsuranceRatio(float insuranceRatio) {
    ...
    public boolean accessContract(Contract registration) {
    	
		return contractList.add(registration);
