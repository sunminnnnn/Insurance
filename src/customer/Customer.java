...
public class Customer extends PCustomer {
    ...
    private PCustomer pCustomer;

    public PCustomer getpCustomer() {
		return pCustomer;
	}

	public void setpCustomer(PCustomer pCustomer) {
		this.pCustomer = pCustomer;
	}
	 public String geCustomertAge() {
			return age;
		}
    ...
    public boolean setContract(Contract contract) {
    	return this.contract.add(contract);
    }
