...
//        //그냥 리스트 전체를 다 불러온 경우
//        for (int i = 0; i < contractList.getContractList().size(); i++) {
//            System.out.println("계약 날짜: " + contract.getDate() + "  계약 ID: " + contract.getContractID() +
//                    "  보험 이름: " + contract.getInsurance().getInsuranceName() + "  고객 이름: " + contract.getCustomer().getCustomerName());
//        }
...
//                System.out.println("계약 날짜: " + contract.getDate() + "   보험명: " + contract.getInsurance().getInsuranceName()
//                        + "   고객 이름: " + contract.getCustomer().getCustomerName() + "   전화번호: " + contract.getCustomer().getCustomerNumber()
//                        + "   납입 보험료 :" + contract.getPrice() + "   만기일: " + contract.getEndDate());
//            }
//
